...
const OurStory = () => {
  return (
    <section className="container border border-info">
      <div className="row">
        <div className="col-12 col-md-4 offset-md-1 border p-0">
          <Image src={nature} alt='Nature' className='img-fluid border border-danger'/>
        </div>
      ...
      <div className="row">
        <div className="col-12 col-md-3 offset-md-2 p-0 border border-info d-flex justify-contents-start">
          <Image src={skyscrapper} alt='' className='img-fluid border border-danger align-self-start'/>
        </div>
